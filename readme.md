В данном проекте находится файл с расширением ".sol" - это смарт-контракт "Агентство недвижимостей", написанный на Solidity. В остальных файлах подключение к сети Ethereum и
